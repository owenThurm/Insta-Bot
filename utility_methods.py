...
def randomCommentText():
    comments = ["Ay DM @genuineaesthetic real quick",
                "It’s a vibe! shoot @genuineaesthetic a dm when you can",
...
<<<<<<< HEAD
                ...
                "Dope! dm @genuineaesthetic when you can",
                "Dope! dm @genuineaesthetic when you can",
                "Dope! dm @genuineaesthetic whenever you get the chance!",
                "Dope! dm @genuineaesthetic when you get the chance",
                "Dope! when you get the chance shoot a dm to @genuineaesthetic",
                "Dope! when you’re free shoot a dm to @genuineaesthetic",
                "Dope! when you’re free dm @genuineaesthetic!",
                "Dope! when you get some time shoot a dm to @genuineaesthetic",
                "Dope! shoot a dm to @genuineaesthetic when you get the time",
                "Dope! shoot a dm to @genuineaesthetic when you get a chance",
                "Dope! shoot a dm to @genuineaesthetic when you get the chance",
                "Dope fr! shoot a dm to @genuineaesthetic when you get the time",
                "Dope fr! shoot a dm to @genuineaesthetic whenever your get a chance",
                "Dope fr! whenever you're free shoot a dm to @genuineaesthetic",
                "Dope! dm @genuineaesthetic whenever you’re free!",
=======
...
>>>>>>> f278f980dc59d0e945d76d4d144e67c415a3b31e
                ...
                "That's whats up, when you get the chance shoot a dm to @genuineaesthetic",
...
<<<<<<< HEAD
    ...
    #return u"Dope! shoot a dm to @genuineaesthetic when you get the chance \u2764"
=======
                "That's whats up, shoot a dm to @genuineaesthetic when you get the time!",
                "You have some dope style! Shoot a dm to @genuineaesthetic whenever you get the chance!",
                "You have some dope style! Shoot @genuineaesthetic a dm when you get the chance!",
                "You have some dope style! Shoot @genuineaesthetic a dm whenever you get the time!",
                "You have some dope style! Shoot @genuineaesthetic a dm whenever you have a minute!",
                "You have some dope style! Whenever you get the time shoot a dm to @genuineaesthetic",
                "You have some dope style! Whenever you get some time shoot a dm to @genuineaesthetic",
                "You have some dope style! Whenever you get a minute dm @genuineaesthetic",
                "You have some dope style! When you get a minute send a dm to @genuineaesthetic",
                "You have some dope style! When you have some time shoot a dm to @genuineaesthetic",
                "You have some dope style! When you have a minute shoot a dm to @genuineaesthetic",
                "You have some dope style fr! When you have a second, shoot a dm to @genuineaesthetic",
                "You have some dope style fr! When you get some time, shoot a quick dm to @genuineaesthetic",
                "You have some dope style for real! Whenever you're free, shoot a dm to @genuineaesthetic",
                "You have some dope style for real! Whenever you're free, shoot a dm to @genuineaesthetic",
                "You have some dope style for real! When you get the chance, shoot a quick dm to @genuineaesthetic",
                "You have some dope style for real! Whenever you get a chance, shoot a quick dm to @genuineaesthetic",
                "You have some dope style for real! Whenever you get a chance, shoot a dm to @genuineaesthetic",
                "You have a dope vibe for real! Shoot a dm to @genuineaesthetic whenever you can!",
                "You have a dope vibe for real! Shoot a dm to @genuineaesthetic when you get the chance!",
                "You have a dope vibe for real! Dm @genuineaesthetic when you get a chance!",
                "You have a dope vibe for real! Send a quick dm to @genuineaesthetic whenever you get a chance!",
                "You have a dope vibe for real! Send a dm to @genuineaesthetic whenever you find the time!",
                "You have a dope vibe! Shoot a quick dm to @genuineaesthetic when you can!",
                "You have a dope vibe! Shoot a dm to @genuineaesthetic when you get a chance!",
                "You have a dope vibe fr! Shoot a quick dm to @genuineaesthetic when you get the time!"]
>>>>>>> f278f980dc59d0e945d76d4d144e67c415a3b31e
...
def randomCommentTextMain():
    comments = ["It’s a vibe! shoot us a dm when you can",
                ...
                "That's whats up, when you get the chance shoot a dm to us",
